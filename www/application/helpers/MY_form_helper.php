...
function form_timezone($name, $value='', $attrs = '') {
    $tz_list = array(
        '' => 'Time Zone',
        'America/Adak' => 'Hawaii-Aleutian Time Zone (UTC-10)',
        'America/Anchorage' => 'Alaska Time Zone (UTC-9)',
        'America/Los_Angeles' => 'Pacific Time Zone (UTC-8)',
        'America/Denver' => 'Mountain Time Zone (UTC-7)',
        'America/Chicago' => 'Central Time Zone (UTC-6)',
        'America/New_York' => 'Atlantic Time Zone (UTC-5)'
    );
