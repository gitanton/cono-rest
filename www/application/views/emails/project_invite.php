...
$msg .=
  ...
  <p><a style="color:#1496cf" href="'.$CI->config->item('webapp_url').'#/invitation/'.$invite->key.'/'.INVITE_TYPE_PROJECT.'">Accept Invitation</a></p>';

$msg_text = $user->fullname." has invited you to join a ".$CI->config->item('site_title')
    ." project. To accept the invitation, click the link below.  If you do not have an account, you will be prompted to create one.\n"
    .$CI->config->item('webapp_url').'#/invitation/'.$invite->key.'/'.INVITE_TYPE_PROJECT;
