...
define('ACTIVITY_TYPE_DRAWING_VIDEO_ADD', 20);
define('ACTIVITY_TYPE_DRAWING_SCREEN_ADD', 21);
define("ACTIVITY_TYPE_HOTSPOT_SCREEN_DELETE", 22);
define("ACTIVITY_TYPE_DRAWING_SCREEN_DELETE", 23);
